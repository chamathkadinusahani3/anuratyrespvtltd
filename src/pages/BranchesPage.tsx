...
export function BranchesPage() {
  const { track } = useActivityTracker({ type: 'page_view', page: '/branches' });

  const handleGetDirections = (branch: typeof BRANCHES[0]) => {
    track({ type: 'branch_view', item: branch.name, detail: branch.address, page: '/branches' });
      ...
      <div className="relative bg-black py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-brand-gray max-w-3xl mx-auto leading-relaxed">
            Visit one of our conveniently located service centers across Sri Lanka.
          </p>
        </div>
      </div>
      ...
      <div className="bg-black py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {BRANCHES.map((branch) =>
              <Card key={branch.id} className="overflow-hidden flex flex-col md:flex-row">
                ...
                <div className="p-8 flex-1">
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <p className="text-brand-gray">Mon - Sat: 8:30 AM - 6:00 PM</p>
                    </div>
                  </div>

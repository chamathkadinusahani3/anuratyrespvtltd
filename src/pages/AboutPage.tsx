      ...
      <div className="relative bg-black py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-brand-gray max-w-3xl mx-auto leading-relaxed">
            ...
            premium vehicle care, combining expert craftsmanship with world-class technology.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-24">
            <Card className="p-8 text-center">
              ...
              <p className="text-brand-gray text-sm">Decades of experience serving Sri Lankan motorists with integrity.</p>
            </Card>
            <Card className="p-8 text-center">
              ...
              <p className="text-brand-gray text-sm">Authorized dealer for world-renowned tyre and part brands.</p>
            </Card>
            <Card className="p-8 text-center">
              ...
              <p className="text-brand-gray text-sm">Highly trained technicians certified in modern automotive systems.</p>
            </Card>
            <Card className="p-8 text-center">
              ...
              <p className="text-brand-gray text-sm">Recognized for excellence in customer service and technical standards.</p>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6 text-brand-gray leading-relaxed">
                ...
                <p>
                  It was started with a little group of young tyre enthusiasts & a highly efficient team of marketing staff, Anura Tyres started with a highly reference able client base. Among the attributes that has enabled Anura tyres to reach the top were, Vision, Integrity, Professionalism & Service standards etc.
                </p>
              </div>
            </div>
            <div className="relative">
              <div className="absolute inset-0 bg-brand-yellow transform rotate-3 rounded-2xl opacity-20" />
              <img src="./hero-bg.png" alt="Workshop" className="relative rounded-2xl shadow-2xl border border-white/10" />
            </div>
          </div>
        </div>
      </div>
